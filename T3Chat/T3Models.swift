...
struct ConversationMessage: Codable {
  ...
  enum CodingKeys: String, CodingKey {
    case id, role, model, status, content, threadId, created_at, modelParams, attachments,
      providerMetadata, errorReason
  }

  init(
    id: String, role: String, model: String, status: String, content: String, threadId: String?,
    created_at: String?, modelParams: [String: String]?, attachments: [AnyCodable]?,
    providerMetadata: ProviderMetadata?, errorReason: String?
  ) {
    self.id = id
    self.role = role
    self.model = model
  ...
  init(from decoder: Decoder) throws {
    ...
    providerMetadata = try container.decodeIfPresent(
      ProviderMetadata.self, forKey: .providerMetadata)
  ...
  func encode(to encoder: Encoder) throws {
    ...
    default:
      let context = EncodingError.Context(
        codingPath: encoder.codingPath, debugDescription: "AnyCodable value cannot be encoded")
